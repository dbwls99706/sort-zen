...
### P0 — 코어 루프 만족감
- [ ] T110 진짜 액체 붓기 연출 — 소스 튜브 기울기 + 연결된 액체 스트림(Skia) + 착지 출렁/스플래시, 게임 화면 실제 연결, 사운드 착지 동기화
- [ ] T111 Tube 고급 렌더링 — 색별 수직 그라데이션 + 유리 광택/림라이트 + 메니스커스 + 기포, 외곽선 대비 상향
- [ ] T112 per-tube 완성 보상 — 튜브 단색 완성 순간 complete_tube 사운드 + 햅틱 + 글로우/팝 연출
