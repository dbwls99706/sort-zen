...
- [ ] T142 막힘 감지 — 합법수 0 && 미완성 시 안내(되돌리기/새 보드), ZEN 컨셉 보호
### P1 — 리텐션/수익 레버
- [ ] T143 힌트 — 솔버 다음 1수 하이라이트(코인 or 리워드 광고)
- [ ] T144 추가튜브 — 리워드 광고로 빈 튜브 1개 추가(ZEN 제외, 데드엔드 회복)
- [ ] T145 무브 효율 별점·코인 차등 — 최적수(솔버) 대비 별 1~3 + 코인 차등
- [ ] T146 도전과제/데일리(T103) 메뉴·게임 연결 마무리
### P2 — 난이도 튜닝
...
- [ ] T151 햅틱 디테일 — 부을 수 없는 탭 light 피드백 + 붓는 동안 연속 햅틱 패턴(물 흐름 촉감)
- [ ] T152 메니스커스 붓기 반응 — 액체를 받은 튜브 표면이 크게 출렁였다가 잦아드는 서지 애니메이션