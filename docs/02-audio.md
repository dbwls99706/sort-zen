...
| `bgm_zen.mp3` | ZEN 모드 BGM | 5분 루프, 잔잔 |
| `bgm_classic.mp3` | 클래식 모드 BGM | 끄기 가능 |

**자산 출처**: freesound.org (CC0), Pixabay Music, Zapsplat. GarageBand 실로폰 12음 직접 녹음 권장 (10분 작업).

**파일 형식**: mp3 권장 (Android/iOS 모두 지원, expo-av 호환).
